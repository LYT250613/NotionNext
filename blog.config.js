...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.qwxl.ac.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '青梧新论,文学期刊,官方网站,文学评论期刊,青梧新论投稿,扶摇诗刊,文学杂志', // 网站关键词 英文逗号隔开
